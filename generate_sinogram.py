...
def main_multiplex(energy_name='EC',directory_air ='.',dir_home='.',
    ...
    directory_air = "D:/Research/sCT Scan Data/Au_scT_Devon/Air/"
    dir_home = "D:/Research/sCT Scan Data/Au_scT_Devon/"
    ...
    translations = np.array(["-18.5", "-9", "0.5", "10", "0.5"])
    ...
    for i in np.arange(0, min_proj, 1):
...
#def find_duplicate(dir_to_search='.'):
#    Dirs = glob.glob("{}".format(dir_to_search))
#    for i in np.arange(len(Dirs-1)):
#        file1 = Dirs[i]
#        file2 = Dirs[i+1]
#        with open(dir_to_search+file1, 'rt') as csvfile:
#            spamreader = csv.reader(csvfile, delimiter=',')
#            for csv_row in spamreader:
...
def main_dark_cor(energy_name='EC', directory_air ='.', dir_home='.',
                  translations=np.array(["10", "0.5", "-9", "-18.5", "0.5"]), dark_file='./Dark&Air/Dark/Dark_1.csv'):
    '''
    This is for the multiplexed 3D-printed phantom (Au, Gd, I)
    :return:
    '''
...
#main_multiplex(energy_name='EC', dir_home='D:/Research/sCT Scan Data/Iod_5_17_19/', directory_air='D:/Research/sCT Scan Data/Iod_5_17_19/Air/')
#find_missing(dir_to_search='D:/Research/sCT Scan Data/Au_sCT_Devon/Rot*/', interpolate=True)
#dark_im = generateImageByReadingCSVdata('D:/Research/sCT Scan Data/Iod_5_17_19/Air/', 'dark.csv')
#air_im = generateImageByReadingCSVdata('D:/Research/sCT Scan Data/Iod_5_17_19/Air/', 'air_-18.48.csv')
#air_im = np.subtract(air_im, dark_im)
#im = generateImageByReadingCSVdata('D:/Research/sCT Scan Data/Iod_5_17_19/Rot_10.23/', '10.23_2019_05_17__18_00_10.csv')
#im - np.subtract(im, dark_im)
#ct = -np.log(im/air_im)
#plt.imshow(air_im)
#plt.show()

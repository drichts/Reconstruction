...
folder = '21-04-14_CT_bin_width_5'
...
np.save(os.path.join(directory, folder, 'phantom_mask_mtf.npy'), phantom_mask)
...
np.save(os.path.join(directory, folder, 'masks_mtf.npy'), masks)

...
folder1 = r'21-02-18_CT_water_only\airscan_60s_gold'
folder2 = r'21-02-18_CT_water_only\airscan_60s_gold_1'

dark = np.load(os.path.join(directory, r'21-02-18_CT_water_only\darkscan_60s_gold\Data\data.npy'))
...
np.save(os.path.join(directory, 'dead_pixel_mask_2.npy'), dpm)

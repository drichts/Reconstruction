...
def convert(folder, directory=r'D:\OneDrive - University of Victoria\Research\LDA Data'):
    """
    ...
    if not os.path.exists(os.path.join(save_air, 'data.npy')):
    ...
    if not os.path.exists(os.path.join(save_dark, 'data.npy')):
